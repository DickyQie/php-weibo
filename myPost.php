<?php
    ...
    $sql = "SELECT * FROM mr_post where ( post_type != 1 and user_id = :user_id) ORDER BY addtime DESC";

    $total = $db->single("select count(*) from mr_post where  post_type != 1 and user_id = :user_id",array('user_id'=>$user_id));//记录总条数
